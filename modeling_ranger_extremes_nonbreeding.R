...
preds <- c(
  ...
  "pland_90_mixed_forest", "eviwin", # change!
  "bio4", "bio15",
  "ehe_w", "ece_w", "spei_w", # change!
  "sim_bio4","sim_bio15",
  "sim_ehe_w","sim_ece_w","sim_spei_w") # change!
# subset for models
preds_m = preds[c(1:47,53:57)]; preds_m = gsub("\\_w$","",preds_m)
preds_v = preds[c(1:49,55:57)]; preds_v = gsub("\\_w$","",preds_v)
preds_e = preds[1:52]; preds_e = gsub("\\_w$","",preds_e)
